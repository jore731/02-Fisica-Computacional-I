 ...
 * 
 * Sin embargo, no podemos concluir lo mismo cuando se trata de la representación de los datos cuando t>50 años. Cuando la desintegración se acerca al final, es decir, cuando el número de nucleos activos es muy bajo, la variación de los resultados es mucho mayor dado que el factor aleatorio es mucho más decisivo, por lo que, con un único muestreo, obtenemos resultados poco fiables como podemos comprobar en las siguientes figuras. Para mejorar estos resultados, sería necesario, igual que con el ejercicio 1, aumentar los ciclos de simulación y ponderar los resultados, de forma que, a lo largo de toda la simulación, la variación de núcleos activos en cada etapa tienda a cero.
 * 
